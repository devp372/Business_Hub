...
@WebServlet(name = "AverageOrderValue", value = "/AverageOrderValue")
public class AverageOrderValue extends HttpServlet {
    @Override
            ...
            if (con != null) {
                ...
                if (ordersSet.next()) {
                    ...
                    for (int i = 0; i < orders.size(); i++) {
                        sales = sales + orders.get(i).getTotalPrice();
                    }
                    double avg = sales / orders.size();
                    String avgValue= gson.toJson(avg);
                    response.getWriter().write(avgValue);
                } else {
